...
(function (g) {
  ...
  function r(a, b, c) {
    ...
    c &&
      ...
      c.children &&
        g.each(c.children, function (a, b) {
          d.appendChild(b);
        }),
      null !== c.text &&
        c.text !== u &&
        d.appendChild(a.createTextNode(c.text)));
    return d;
  }
  function G(a, b) {
  ...
  function B(a) {
    v === u &&
      (v =
        -1 ===
        z
          .serializeToString(g.parseXML(t["xl/worksheets/sheet1.xml"]))
          .indexOf("xmlns:r"));
      ...
      if (g.isPlainObject(c)) B(c);
        ...
        if (v) {
          ...
          for (f = d.attributes.length - 1; 0 <= f; f--) {
            ...
            -1 !== h.indexOf(":") &&
              (e.push({ name: h, value: k }), d.removeAttribute(h));
          }
          f = 0;
          for (h = e.length; f < h; f++)
            (k = c.createAttribute(
              e[f].name.replace(":", "_dt_b_namespace_token_")
            )),
              (k.value = e[f].value),
  ...
  h.hasFlash = function () {
    try {
      ...
      if (
        navigator.mimeTypes &&
        navigator.mimeTypes["application/x-shockwave-flash"] !== u &&
  ...
  var C = function (a, b) {
    ...
    z = "";
  z =
    "undefined" === typeof n.XMLSerializer
      ? new (function () {
  ...
  l.ext.buttons.excelFlash = g.extend({}, y, {
    ...
    action: function (a, b, c, d) {
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            ...
            k ||
              ...
              (a[b].match &&
                ...
                : ((q = a[b].replace
                    ? a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")
                    : a[b]),
                  (k = r(e, "c", {
                    attr: { t: "inlineStr", r: l },
                    children: {
                      row: r(e, "is", {
                        children: { row: r(e, "t", { text: q }) },
                      }),
                    },
                  }))));
            n.appendChild(k);
      ...
      var l = function (a, b) {
          ...
          c[0].appendChild(
            r(e, "mergeCell", { attr: { ref: "A" + a + ":" + A(b) + a } })
          );
      ...
      for (var w = 0, v = k.body.length; w < v; w++) p(k.body[w], f);
      d.footer &&
        k.footer &&
        (p(k.footer, f), g("row:last c", e).attr("s", "2"));
      ...
      for (w = k.header.length; l < w; l++)
        p.appendChild(
          r(e, "col", {
            attr: { min: l + 1, max: l + 1, width: G(k, l), customWidth: 1 },
          })
        );
